...
_C.DATASETS.SCALE_MULTIPLE_OF = 32

_C.DATASETS.MAX_SIZE = 1440
...
# If True, each atch should contain only images for which the aspect ratio
...
_C.MODEL.RPN.POST_NMS_TOP_N_TEST = 200
...
_C.MODEL.ROI_HEADS.QUAD_BBOX_REG_WEIGHTS = (5., 5., 5., 5., 5., 5., 5., 5.)
...
# _C.PATHS_CATALOG = '/home/dl/frameworks/R2CNN.pytorch/maskrcnn_benchmark/config/paths_catalog.py'
